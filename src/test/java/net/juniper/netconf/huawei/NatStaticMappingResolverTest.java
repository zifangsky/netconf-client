...
import net.juniper.netconf.adapter.huawei.natStaticMapping.NatStaticMappingResolver;
import net.juniper.netconf.adapter.huawei.natStaticMapping.NatStaticMappingResolverImpl;
import net.juniper.netconf.adapter.huawei.natStaticMapping.model.*;
